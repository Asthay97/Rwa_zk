import {
  require_aes_js,
  require_scrypt
} from "./chunk-7E2INFKZ.js";
import {
  require_sha3
} from "./chunk-VUTNETB2.js";
import {
  require_buffer,
  require_hash
...
var version9 = "json-wallets/5.7.0";
...
var Wordlist = class _Wordlist {
  constructor(locale) {
    logger14.checkAbstract(new.target, _Wordlist);
...
function getWordlist(wordlist2) {
  ...
  if (typeof wordlist2 === "string") {
    ...
    if (words2 == null) {
      logger15.throwArgumentError("unknown locale", "wordlist", wordlist2);
    }
    return words2;
  }
  return wordlist2;
...
var HDNode = class _HDNode {
  ...
  static fromExtendedKey(extendedKey) {
    ...
    if (bytes.length !== 82 || base58check(bytes.slice(0, 78)) !== extendedKey) {
      logger15.throwArgumentError("invalid extended key", "extendedKey", "[REDACTED]");
    }
    const depth = bytes[4];
    ...
    return logger15.throwArgumentError("invalid extended key", "extendedKey", "[REDACTED]");
  }
};
...
function getAccountPath(index) {
  if (typeof index !== "number" || index < 0 || index >= HardenedBit || index % 1) {
    logger15.throwArgumentError("invalid account index", "index", index);
  }
  return `m/44'/60'/${index}'/0/0`;
}

// node_modules/@ethersproject/random/lib.esm/_version.js
var version15 = "random/5.7.0";
...
var logger17 = new Logger(version9);
...
//# sourceMappingURL=chunk-CGZOTXLM.js.map

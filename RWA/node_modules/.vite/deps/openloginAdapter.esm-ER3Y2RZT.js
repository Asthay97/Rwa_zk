    ...
    OpenloginAdapter = class extends BaseAdapter {
      ...
      async connectWithProvider(params) {
        ...
        if (this.currentChainNamespace === CHAIN_NAMESPACES.SOLANA) {
          ...
          } = await import("./solanaProvider.esm-63RASWTR.js");
          ...
          } = await import("./ethereumProvider.esm-GEX6GAE4.js");
        ...
        if (finalPrivKey) {
          if (this.currentChainNamespace === CHAIN_NAMESPACES.SOLANA) {
            const {
              getED25519Key
            } = await import("./openloginEd25519.esm-KV7R4YHT.js");
...
//# sourceMappingURL=openloginAdapter.esm-ER3Y2RZT.js.map

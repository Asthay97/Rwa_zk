import {
  ...
  providerFromEngine
} from "./chunk-JBF7TIZL.js";
import {
  require_nacl_fast
} from "./chunk-6JXW2ZTE.js";
import {
  esm_browser_exports,
  init_esm_browser
} from "./chunk-HP2ZKEXX.js";
import {
  CHAIN_NAMESPACES,
  JRPCEngine,
  ...
  require_safe_buffer,
  require_typeof
} from "./chunk-KY7BYEEG.js";
import {
  _defineProperty,
  init_defineProperty
} from "./chunk-DPVQT5CK.js";
import {
  require_buffer
} from "./chunk-CGUI5JNX.js";
import {
  __commonJS,
  __esm,
  __export,
...
var import_bs582, import_eth_rpc_errors, import_tweetnacl_js, BaseInjectedProvider, getBaseProviderHandlers, PhantomInjectedProvider, getSlopeHandlers, SlopeInjectedProxyProvider, getSolflareHandlers, SolflareInjectedProvider, getSolletHandlers, SolletInjectedProvider, getTorusHandlers, TorusInjectedProvider, SolanaPrivateKeyProvider, SolanaWallet;
    ...
    getSlopeHandlers = (injectedProvider, getProviderEngineProxy) => {
      const providerHandlers = {
        ...
        signTransaction: async (req) => {
          ...
          const {
            data
          } = await injectedProvider.signTransaction(import_bs582.default.encode(txMessage.serializeMessage()));
        ...
        signAllTransactions: async (req) => {
          ...
          const publicKey2 = new PublicKey(data.publicKey);
          for (let i = 0; i < length; i++) {
            const signature = import_bs582.default.decode(data.signatures[i]);
...
@noble/curves/esm/secp256k1.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=chunk-XRIWVBQN.js.map

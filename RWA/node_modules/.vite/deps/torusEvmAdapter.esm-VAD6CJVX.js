...
import {
  ...
  require_stream
} from "./chunk-JIPSK4M2.js";
import {
  require_util as require_util2
} from "./chunk-E3RHFBFR.js";
import {
  _objectWithoutPropertiesLoose,
  init_objectWithoutPropertiesLoose
} from "./chunk-CCJMBKCR.js";
import {
  ADAPTER_CATEGORY,
  ADAPTER_EVENTS,
  ADAPTER_NAMESPACES,
...
var require_safe_event_emitter = __commonJS({
  "node_modules/@metamask/safe-event-emitter/index.js"(exports) {
    ...
    var SafeEventEmitter2 = class extends events_1.EventEmitter {
      emit(type, ...args) {
        let doError = type === "error";
        const events = this._events;
        if (events !== void 0) {
        ...
        if (typeof handler === "function") {
          ...
          for (let i = 0; i < len; i += 1) {
            safeApply2(listeners[i], this, args);
          }
        }
        return true;
      }
    };
    exports.default = SafeEventEmitter2;
  }
});
...
//# sourceMappingURL=torusEvmAdapter.esm-VAD6CJVX.js.map
